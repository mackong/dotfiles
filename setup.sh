...
if [ "$(uname)" == "Darwin" ]; then
    ...
    brew install antlr ascii autoconf automake bat bison cmake csvlens coreutils dos2unix extra-cmake-modules ffmpeg flex git-lfs go graphviz guile jq maven maxima meson moreutils neovim node openjdk pre-commit python-lsp-server radare2 rcm ripgrep texlive tmux tree tree-sitter uv websocat xz
    brew install --cask alacritty docker google-chrome wireshark-app

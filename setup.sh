...
font-lxgw-wenkai fx git-lfs go graphviz guile jq maven maxima meson moreutils neovim node openjdk pngpaste pre-commit python-lsp-server radare2 rcm ripgrep texlive tmux tree tree-sitter uv wader/tap/fq websocat xz

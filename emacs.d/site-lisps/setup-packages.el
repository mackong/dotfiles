...
(use-package eaf
  ...
  (eaf-setq eaf-browser-font-family "Cascadia Code PL")
  (eaf-setq eaf-browser-enable-autofill "true")
  (eaf-setq eaf-terminal-font-size "13")
  (eaf-setq eaf-terminal-font-family "Cascadia Code PL")
  (eaf-setq eaf-mindmap-edit-mode "true")
  (eaf-setq eaf-mindmap-save-path "~/Documents/Diagrams")
  (eaf-setq eaf-jupyter-font-size "13")
  (eaf-setq eaf-jupyter-font-family "Cascadia Code PL")

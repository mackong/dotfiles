...
(use-package eaf
  ...
  (eaf-setq eaf-browser-font-family "Noto Sans Mono")
  (eaf-setq eaf-browser-enable-autofill t)
  (eaf-setq eaf-terminal-font-size 14)
  (eaf-setq eaf-terminal-font-family "Noto Sans Mono")
  (eaf-setq eaf-mindmap-edit-mode t)
  (eaf-setq eaf-mindmap-save-path "~/Documents/Diagrams")
  (eaf-setq eaf-jupyter-font-size 14)
  (eaf-setq eaf-jupyter-font-family "Noto Sans Mono")
  (eaf-setq eaf-pdf-dark-exclude-image t)
